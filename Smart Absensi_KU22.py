...
def rekamDataWajah():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            namaFile = str(nohp) + '_'+str(nama) + '_' + \
                str(email) + '_' + str(ambilData) + '.jpg'
            ...
            for (xe, ye, we, he) in eyes:
                cv2.rectangle(roiwarna, (xe, ye),
                              (xe + we, ye + he), (0, 255, 255), 1)
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if (confidence < 100):
                ...
                id = "Tidak Diketahui"
                confidence = "  {0}%".format(round(500 - confidence))
...
# judul
judul = tk.Label(root, text="Smart Absensi Kelompok U22",
                 font=("Roboto", 34), bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
# credit
made = tk.Label(root, text="Kelompok U22", font=(
    "Times New Roman", 13), bg="blue", fg="white")
...
label1 = tk.Label(root, text="Nama Anggota",
                  font="Roboto", fg="white", bg="blue")
canvas.create_window(90, 170, window=label1)
# for entry data Nomoor HP
entry2 = tk.Entry(root, font="Roboto")
canvas.create_window(457, 210, height=25, width=411, window=entry2)
label2 = tk.Label(root, text="NO HP", font="Roboto", fg="white", bg="blue")
...
label3 = tk.Label(root, text="Email", font="Roboto", fg="white", bg="blue")
...
Rekam_btn2 = tk.Button(root, textvariable=Rekam_text2, font="Roboto",
                       bg="#20bebe", fg="white", height=1, width=20, command=absensiWajah)
